    ...
    class EmpDal
    {
        public SqlDataReader GetEmployeeData ()
        {
            ...
            try
            {
                ...
                conn.ConnectionString = "Server =.; Database= EmployeeDepartmentDB; trusted_connection=true";
                conn.Open();
        ...
        public int InsertEmployee(int empno, string empname, string designation, float salary, int deptno)
        {
            SqlConnection conn = null;
            int res = 0;
        ...
        public int UpdateEmployee(int empno, string empname, string designation, float salary, int deptno)
        {
            SqlConnection conn = null;
            int res = 0;
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                Console.WriteLine("2. Get specific Employee Details");
